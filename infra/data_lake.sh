...
DATA_LAKE_STORAGE='lvstorageaccount2'
...
DATA_LAKE_SERVER_NAME='lauravqslserver'
DATA_LAKE_DATABASE_NAME='lauravsqldb'
ADMIN_USERNAME='lauraverkerk'
ADMIN_PASSWD='sqlserver123!'
